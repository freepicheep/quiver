...
fn install_resolved(
    ...
    let project_dir = nu_env_dir
        .parent()
        .unwrap_or(nu_env_dir);
...
pub fn write_activate_overlay(
    ...
    eprintln!("Generated {}", activate_path.strip_prefix(project_dir).unwrap_or(&activate_path).display());
    Ok(())
}
